        ...
        <section className="py-24 px-6 relative z-20">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Feature 1: HOLOGRAPHIC GLASS */}
              <div className="bg-transparent backdrop-blur-3xl border-t border-l border-purple-500/30 border-b-0 border-r-0 rounded-3xl p-8 hover:bg-white/[0.02] hover:border-purple-400/60 transition-all duration-300 group shadow-[0_0_30px_rgba(168,85,247,0.05)] relative overflow-hidden flex flex-col h-full">
