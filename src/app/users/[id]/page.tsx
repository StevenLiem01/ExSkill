    ...
    <AuthProvider>
      <main className="min-h-screen bg-[#0B061A] text-white p-6 md:p-12 relative overflow-hidden pb-20 selection:bg-purple-500/30">
        ...
        <div className="max-w-6xl mx-auto space-y-10 relative z-10">
          ...
          <div className="flex justify-between items-center bg-white/5 backdrop-blur-xl p-6 rounded-2xl border border-white/10 shadow-[0_0_15px_rgba(139,92,246,0.1)]">
