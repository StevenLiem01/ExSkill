...
function ModerationDashboard() {
  ...
  return (
    <main className="min-h-screen bg-[#0B061A] text-white p-6 md:p-12 relative overflow-hidden selection:bg-red-500/30">
      {/* Dekorasi */}
      <div className="absolute top-0 right-0 w-[40rem] h-[40rem] bg-red-600/10 rounded-full blur-[120px] pointer-events-none"></div>
